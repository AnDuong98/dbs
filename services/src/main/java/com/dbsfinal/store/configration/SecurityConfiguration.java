package com.dbsfinal.store.configration;

import com.dbsfinal.store.security.AuthEntryPointJwt;
import com.dbsfinal.store.security.JwtRequestFilter;
import com.dbsfinal.store.security.UserDetailsServiceImpl;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers(HttpMethod.GET,"/order/**", "/users/**" ,"/user/**", "/products/**", "/categories/**", "/role/**", "/promotions/**","/directDealsBanks/**").permitAll()
